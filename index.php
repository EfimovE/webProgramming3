...
$skills = [
['name' => 'Offline sales', 'precent' => 85],
['name' => 'Online sales', 'precent' => 87],
['name' => 'Communicacabe', 'precent' => 97], 
['name' => 'Learnability', 'precent' => 93], 
]; 
$jobs = [
[ 'name' => 'Marketplace manager', 
  'dateStart' =>'Jan 2015', 
  'dateEnd' => 'Current',
  'description' => 'Аssistance in sellinggoods on the Wildberries, Ozon, Yandex. Market", "SberMegaMarket" and other
marketplaces.',
], 
[ 'name' => 'Product sales manager', 
  'dateStart' => 'Mar2012', 
  'dateEnd' => 'Dec 2014', 
  'description' => 'Conducting business negotiations with the first persons of the company',
 ], 
 [ 'name' => 'Salestrainee', 
   'dateStart' => 'Jun 2010',
   'dateEnd' => 'Mar 2012', 
   'description' =>'Search for new partners - service providers (online stores, beauty salons,
fitness centers, bowling alleys, concert venues, etc.); maintenance of the
existing base; preparation of documents (presentations, commercial offers)',
],
]; 
?>
        ...
        <div class="w3-third">
          <div class="w3-white w3-text-grey w3-card-4">
            <div class="w3-display-container">
              <img
                src="https://imgfon.ru/Images/Details_img_880px/Animals/glaza-belyy_fon-kotik-morda-polosatyy.webp"
                style="width: 100%"
                alt="Avatar"
              />
            ...
            <div class="w3-container">
              ...
              <p>
                <i
                  class="fa fa-hourglass-half fa-fw w3-margin-right w3-large w3-text-teal"
                ></i
                ><?php echo $age ?>
                лет (<?php echo $days ?>
                дней)
              ...
              <div class="w3-light-grey w3-round-xlarge w3-small">
                <div
                  ...
                  style="width:<?php echo $skills[$i]['precent']; ?>%"
                >
                  <?php echo $skills[$i]['precent']; ?>
                </div>
              </div>
              <?php endfor; ?>
              <br />
          ...
          <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <div class="w3-container">
              ...
              <h6 class="w3-text-teal">
                ...
                <?=$jobs[$i]['dateStart']; ?>
                -
                <?php if ($i == 0): ?><span class="w3-teal w3-round">
                  <?=$jobs[$i]['dateEnd']; ?></span
                >
                <?php else: ?>
                <?=$jobs[$i]['dateEnd']; ?>
